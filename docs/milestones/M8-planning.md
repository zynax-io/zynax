...
| **M8.E** | Thin `Workflow` CRD front-end (GitOps authoring; zero run-state in etcd) | feat | **#1573** ✅ **DELIVERED** (ADR-043 + PRs #1615–#1618 + e2e/docs; canvas Implemented) | workflow-compiler, infra, cli | [ADR-043](../adr/ADR-043-workflow-crd-front-end.md) ✅ Accepted |
| **M8.F** | Edge delegation: gateway auth + rate-limit → Gateway API / Envoy | feat | **#1574** ✅ **DELIVERED** (ADR-044 + PRs #1629–#1632 + rate-limit; canvas Implemented) | api-gateway, infra | [ADR-044](../adr/ADR-044-gateway-api-edge-auth-ratelimit.md) ✅ Accepted (amends ADR-040) |

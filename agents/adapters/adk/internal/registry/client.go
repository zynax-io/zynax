...
// adk-adapter with AgentRegistryService on startup and graceful shutdown.
package registry
...
// Retries up to 5 times on transient gRPC errors; base delay 2 s, doubles each
// attempt. Non-transient errors (INVALID_ARGUMENT, ALREADY_EXISTS, …) are returned
// immediately.

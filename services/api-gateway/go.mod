...
require (
	...
	github.com/zynax-io/zynax/libs/zynaxobs v0.0.0
...
replace github.com/zynax-io/zynax/libs/zynaxobs => ../../libs/zynaxobs

replace github.com/zynax-io/zynax/libs/zynaxevents => ../../libs/zynaxevents

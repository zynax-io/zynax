...
func TestEventNameValidator(t *testing.T) {
	cases := []struct {
		...
		{"underscore", "review_approved", false},
		{"capability_completed", "code_review.completed", false},
		{"shipped_summarize_feedback", "summarize_feedback.completed", false},
		{"empty", "", true},
		{"uppercase", "Review.Approved", true},
		{"leading_dot", ".approved", true},
		{"trailing_dot", "review.", true},
		{"double_dot", "review..approved", true},
		{"leading_underscore", "_review.approved", true},
		{"trailing_underscore", "review_.approved", true},
		{"double_underscore", "review__approved", true},

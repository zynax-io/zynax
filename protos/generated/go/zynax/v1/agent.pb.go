...
// GetCapabilitySchemaRequest identifies the capability to introspect.
type GetCapabilitySchemaRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The capability name to introspect.
	// Format: same as ExecuteCapabilityRequest.capability_name.
	// Required: empty string is rejected with INVALID_ARGUMENT.
...
func (x *GetCapabilitySchemaRequest) Reset() {
	*x = GetCapabilitySchemaRequest{}
	mi := &file_zynax_v1_agent_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetCapabilitySchemaRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetCapabilitySchemaRequest) ProtoMessage() {}

func (x *GetCapabilitySchemaRequest) ProtoReflect() protoreflect.Message {
	mi := &file_zynax_v1_agent_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetCapabilitySchemaRequest.ProtoReflect.Descriptor instead.
func (*GetCapabilitySchemaRequest) Descriptor() ([]byte, []int) {
	return file_zynax_v1_agent_proto_rawDescGZIP(), []int{3}
}

func (x *GetCapabilitySchemaRequest) GetCapabilityName() string {
	if x != nil {
		return x.CapabilityName
	}
	return ""
...
// GetCapabilitySchemaResponse carries the live schema for a capability.
type GetCapabilitySchemaResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The capability name this schema describes.
	CapabilityName string `protobuf:"bytes,1,opt,name=capability_name,json=capabilityName,proto3" json:"capability_name,omitempty"`
	// JSON Schema (draft-07) describing the valid input_payload structure.
	// Identical to the schema registered in AgentRegistryService when the
	// agent is healthy and up-to-date.
	...
	// JSON Schema (draft-07) describing the result_payload structure.
...
func (x *GetCapabilitySchemaResponse) Reset() {
	*x = GetCapabilitySchemaResponse{}
	mi := &file_zynax_v1_agent_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetCapabilitySchemaResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetCapabilitySchemaResponse) ProtoMessage() {}

func (x *GetCapabilitySchemaResponse) ProtoReflect() protoreflect.Message {
	mi := &file_zynax_v1_agent_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetCapabilitySchemaResponse.ProtoReflect.Descriptor instead.
func (*GetCapabilitySchemaResponse) Descriptor() ([]byte, []int) {
	return file_zynax_v1_agent_proto_rawDescGZIP(), []int{4}
}

func (x *GetCapabilitySchemaResponse) GetCapabilityName() string {
	if x != nil {
		return x.CapabilityName
	}
	return ""
...
func (x *GetCapabilitySchemaResponse) GetInputSchemaJson() string {
	if x != nil {
...
func (x *GetCapabilitySchemaResponse) GetOutputSchemaJson() string {
	if x != nil {
...
func (x *GetCapabilitySchemaResponse) GetDescription() string {
	if x != nil {
...
const file_zynax_v1_agent_proto_rawDesc = "" +
	...
	"\x0fcapability_name\x18\x01 \x01(\tR\x0ecapabilityName\"\xc2\x01\n" +
	...
	"\x16TASK_EVENT_TYPE_FAILED\x10\x032\xc2\x01\n" +
	"\fAgentService\x12N\n" +
	"\x11ExecuteCapability\x12\".zynax.v1.ExecuteCapabilityRequest\x1a\x13.zynax.v1.TaskEvent0\x01\x12b\n" +
...
var file_zynax_v1_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_zynax_v1_agent_proto_goTypes = []any{
	...
	(*GetCapabilitySchemaRequest)(nil),  // 4: zynax.v1.GetCapabilitySchemaRequest
	(*GetCapabilitySchemaResponse)(nil), // 5: zynax.v1.GetCapabilitySchemaResponse
	nil,                                 // 6: zynax.v1.CapabilityError.DetailsEntry
	(*timestamppb.Timestamp)(nil),       // 7: google.protobuf.Timestamp
}
var file_zynax_v1_agent_proto_depIdxs = []int32{
	0, // 0: zynax.v1.TaskEvent.event_type:type_name -> zynax.v1.TaskEventType
	7, // 1: zynax.v1.TaskEvent.timestamp:type_name -> google.protobuf.Timestamp
	3, // 2: zynax.v1.TaskEvent.error:type_name -> zynax.v1.CapabilityError
	6, // 3: zynax.v1.CapabilityError.details:type_name -> zynax.v1.CapabilityError.DetailsEntry
	1, // 4: zynax.v1.AgentService.ExecuteCapability:input_type -> zynax.v1.ExecuteCapabilityRequest
	4, // 5: zynax.v1.AgentService.GetCapabilitySchema:input_type -> zynax.v1.GetCapabilitySchemaRequest
	2, // 6: zynax.v1.AgentService.ExecuteCapability:output_type -> zynax.v1.TaskEvent
	5, // 7: zynax.v1.AgentService.GetCapabilitySchema:output_type -> zynax.v1.GetCapabilitySchemaResponse

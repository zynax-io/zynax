...
| **M6** (🚧 Active) | **Delivered:** mTLS ✅, supply-chain (cosign+SBOM+multi-arch) ✅, Postgres repos (#626) ✅, Helm charts (#765) ✅, EventBus over NATS (#772) ✅, images.yaml SoT + ADR-024 (#855) ✅, self-hosting dev-automation (#873) ✅, orchestrator hardening (#1001) ✅, memory-service KV+vector (#773) ✅. **In progress:** ArgoEngine (#766), multi-namespace (#767), policy/rate-limit (#768), Prometheus/OTel (#467), SDK PyPI (#769), e2e harness (#770) | M7 observability, M8 CNCF submission |
